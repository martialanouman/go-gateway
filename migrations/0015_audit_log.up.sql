...
-- resource path — never a body or a query string (invariant a). status NULL means the outcome was not
-- recorded, not that the request succeeded. No code path deletes a row (spec: immutable, 1-7 years).
