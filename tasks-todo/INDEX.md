...
- [x] step-250b — Chaos : flapping connecteur, un règlement par message et aucun perdu (invariant c)
- [x] step-250c — La suite de résilience M8 tourne en CI ; en CI, un test d'intégration qui saute échoue
...
- [ ] step-270c — Le banc ne traverse pas l'étage L0 : le rendre mesurable (ratios, pas verdict)
      ⛓ step-250e, step-270b
...
- [x] step-260i — `processOne` (239 lignes) en trois temps, `connectorpool.go` (1 142 lignes) en cinq fichiers
- [x] step-260j — Un seul codec de curseur keyset (`platform/keyset`) à la place de trois copies
