...
func New(deps Deps) (*chi.Mux, huma.API) {
	...
	registerConnectors(api, deps.Connectors, deps.ConnectorControl)
	...
	registerExactRoutes(api, deps.ExactRoutes, deps.ExactRouteCache, deps.ExactRouteReload,
		deps.Imports, deps.Logger)
	...
	registerContentKeys(api, deps.ContentKeys, deps.ContentKeyEraser, deps.Logger)
