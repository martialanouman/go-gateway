...
func TestProductionRejectsLocalhostDefaults(t *testing.T) {
	tests := []struct {
		...
		{"clickhouse password defaulted", map[string]string{
			"POSTGRES_URL": "postgres://u:p@db:5432/gw", "KAFKA_BROKERS": "k1:9092",
			"CLICKHOUSE_ADDR": "ch1:9000", "REDIS_URL": "redis://cache:6379",
			"SMPP_SESSION_MANAGER_ADDR": "sessionmgr:7000", "BILLING_ADDR": "billing:7001",
			"CONTENT_KEY_ADDR": "content-key:7002",
		}, "CLICKHOUSE_PASSWORD"},
